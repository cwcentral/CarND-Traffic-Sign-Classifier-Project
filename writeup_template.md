...
Please refer to the image file: exploratory_visualization.png that displays a sample of the images and a graph shows the number of classes spread among the valid dataset.
